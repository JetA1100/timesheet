                ...
                <table id="timesheet">
                    ...
                    <tbody id="insert">
                        <tr>
                            ...
                            <td><input id="timeinsert" type="number" name="time" min="0" value="0" onchange="calculate()" required></td>
                            <td><input id="rateinsert" type="number" name="rate" min="0" value="0" onchange="calculate()" required></td>
                        </tr>
                    </tbody>
                </table>
        </div>
